...
$z=0;
$o=1;
$_SESSION['page']="searchuniversity.php";
$item=null;
...
if($db_found)
{
$sql="select * from files where files.university='".$item."'";
...
$n=$n+$z;
?>
<form action="searchuniversity.php" method="POST">
<ul>
 <li><pre>                                                                                 </pre></li>
